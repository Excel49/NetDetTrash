...
def preprocess_image(gambar):
    ...
    _, _, gambar_blur = preprocess_image_steps(gambar)
    return gambar_blur


def preprocess_image_steps(gambar):
    """Kembalikan tiga tahapan preprocessing: grayscale, CLAHE, dan blur."""
    ...
    return abu_abu, gambar_clahe, gambar_blur
